...
def load_tenant_provisioning_input() -> TenantProvisioningInput:
    ...
    clinic_email = _require_email(os.getenv("BRANA_INITIAL_CLINIC_EMAIL") or os.getenv("BRANA_INITIAL_ADMIN_EMAIL"), "BRANA_INITIAL_CLINIC_EMAIL")
    ...
    admin_password = _password_from_env_or_prompt()
