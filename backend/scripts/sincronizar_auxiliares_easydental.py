...
PADRONIZACAO_TELAS_FRONTEND: list[str] = [
    "Ao alterar arquivo JS/CSS referenciado em index.html, incrementar o sufixo de versão (querystring v=...) para invalidar cache.",
    "Corrigir acentuação/caracteres na origem da tela (renderer/base), não apenas em remendo visual posterior.",
    "Validar o mesmo fluxo em tela nova e em edição para evitar DOM divergente entre estados.",
    "Confirmar cabeçalhos/labels/colunas no frontend final antes de concluir o ajuste.",
]
...
def _print_padronizacao_telas_frontend() -> None:
    print("Regras canônicas de padronização de telas frontend:")
