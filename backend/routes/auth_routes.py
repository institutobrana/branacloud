...
def google_calendar_callback(
    ...
    oauth_logger.info("calendar_oauth_user_context_resolved user_id=%s clinica_id=%s", user_id, clinica_id)
    ...
    try:
        ...
        token_data = exchange_google_calendar_code(str(code or "").strip(), oauth_attempt_id=oauth_attempt_id) if oauth_attempt_id else exchange_google_calendar_code(str(code or "").strip())
