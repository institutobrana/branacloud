...
- Implementar futuramente a correcao pequena de vinculo usuario -> prestador Clinica conforme o contrato `USER-PREST-CONTRATO-B`, somente depois da comparacao documental e sem alterar a protecao estrutural do prestador.
